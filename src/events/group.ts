...
export const openGroupSort = () =>
  pipe(goBack, Effect.tap(navigate(Route.SortGroup())), StateRef.execute)
...
export const openParameters = () =>
  StateRef.execute(navigate(Route.Parameters()))
...
export const toggleTeamsCountType = () =>
  StateRef.execute(
...
export const openDeleteGroup = () =>
  StateRef.execute(Effect.all([goBack, navigate(Route.DeleteGroup())]))
